...
<head>
    ...
    <style type="text/tailwindcss">
        ...
        .btn {
            @apply rounded-md px-2 py-1 text-center font-medium text-slate-700 shadow-sm ring-1 ring-slate-700/10 bg-slate-300 hover:bg-slate-400
        }
        .link {
...
<body class="container mx-auto mt-10 mb-10 max-w-lg">
    <h1 class="title mb-4 text-xl">Laravel 11 Tasks Lists Project - Peperino</h1>
    <h1>@yield('title')</h1>
